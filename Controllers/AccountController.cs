...
namespace MMX4.WebAPI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return await UpdateUser(Utilities.Utilities.GetUserId(this.User), user);
        }
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Utilities.Utilities.GetUserId(this.User) == id && string.IsNullOrWhiteSpace(user.CurrentPassword))
                {
                ...
                if (Utilities.Utilities.GetUserId(this.User) == id && (appUser.UserName != user.UserName || !string.IsNullOrWhiteSpace(user.NewPassword)))
                {
        ...
        {
            return await UpdateUser(Utilities.Utilities.GetUserId(this.User), patch);
        }
        ...
        {
            var userId = Utilities.Utilities.GetUserId(this.User);
